...
import { ColorPickerToolbarPlugin } from '@/components/editor/plugins/toolbar/color-picker-toolbar-plugin';
...
export function Plugins({}) {
    ...
    return (
        <div className="relative">
            <ToolbarPlugin>
                {({ blockType }) => (
                    <div className="sticky top-0 z-10 flex items-center gap-2 overflow-visible border-b bg-background p-1">
